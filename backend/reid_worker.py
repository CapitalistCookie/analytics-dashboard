...
MIN_DETECTION_CONFIDENCE = float(os.getenv("REID_MIN_DETECTION_CONFIDENCE", "0.60"))  # Minimum Frigate confidence
        ...
        try:
            ...
            if match_result:
                ...
                if camera_id not in ENTRY_CAMERAS:
                    ...
                    should_create = self._should_create_person(camera_id, frigate_id, embedding, color_hist)
                    if should_create:
